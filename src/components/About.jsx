      ...
      <section className="flex gap-6 mt-16 md:flex-col w-full">
        <div className="flex gap-6 w-full sm:flex-col">
          <div className="w-1/2 sm:w-full border-2 border-dark-200 p-4 rounded-lg">
            <p className="font-bold text-xl">User-Driven Support</p>
            <p>
          ...
          <div className="w-1/2 sm:w-full border-2 border-dark-200 p-4 rounded-lg">
            <p className="font-bold text-xl">Interactive Discussion Platform</p>
            <p>
        ...
        <div className="flex gap-6 w-full sm:flex-col sm:hidden">
          <div className="w-1/2 sm:w-full border-2 border-dark-200 p-4 rounded-lg">
            <p className="font-bold text-xl">Daily Motivation Quotes</p>
            <p>
              {`
          ...
          <div className="w-1/2 sm:w-full border-2 border-dark-200 p-4 rounded-lg">
            <p className="font-bold text-xl">Educational Homepage</p>
            <p>
              {`
